...
import com.example.patcareteam2.CommentActivity.PostComment;
import com.example.patcareteam2.ProfileFragment.LoadComments;
...
public class ReplyComment extends ListActivity {
	...
	public class LoadComments extends AsyncTask<Void, Void, Boolean> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ReplyComment.this);
				...
				try {
					...
					if (success == 1) {
						...
						for (int i = 0; i < mComments.length(); i++) {
							...
							ReplayedItem ri=new ReplayedItem(time, message, firstname, lastname, image);
	...
	private void updateList() {
		CustumReplayAdapter adapter=new CustumReplayAdapter(ReplyComment.this, Replayed_items);
...
class PostComment extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
            ...
            enteredReplay.setText("");
            SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(ReplyComment.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            pDialog.dismiss();
            if (file_url != null){
            	Toast.makeText(ReplyComment.this, file_url, Toast.LENGTH_LONG).show();
            }
