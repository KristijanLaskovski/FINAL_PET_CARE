...
public class User_Profile_Visit extends ListActivity implements
	...
	private void updateList() {
		CustumAdapterForComments adapter = new CustumAdapterForComments(
				User_Profile_Visit.this, NEW_Comments);
	...
	public void ReplayOnComment(String post_id) {
		Intent i = new Intent(User_Profile_Visit.this, CommentsOnPost.class);
	...
	public void startActivityForShowingLocation(String langitude,
			String latitude) {
		// TODO Auto-generated method stub
		if (langitude.equals("0.0") && latitude.equals("0.0")) {
		} else {

			// TODO Auto-generated method stub
			// Toast.makeText(getActivity(), longitude + " " + latitude,
			// Toast.LENGTH_SHORT).show();
			Intent i = new Intent(User_Profile_Visit.this,
					Map_activity_pet_location.class);
