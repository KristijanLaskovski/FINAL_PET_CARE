...
import com.petcare.teamiki.NavigationDrawerFragment.NavigationDrawerCallbacks;
...
//	    }
	...
	public void onSectionAttached(int position) {
	        ...
	        case 3:
	        	mTitle = "Lost and Found pets";
	        	fragment=new FragmentLostFound();
	            break;
	        case 4:
	        	mTitle = "Adopt a pet";
	        	fragment=new FragmnetAdopt();
	            break;
	        case 5:
	        	mTitle ="Give or Sell a pet";
	        	fragment=new FragmentGiveSell();
	            break;
	        case 6:
	        	mTitle = "Tips for Pet Care";
	        	fragment=new TipsForPetCare();
	            break;
	        case 7:
	        	mTitle ="Near Vet-stations";
	        	fragment=new NearVets();
	            break;
	        default:
	            break;
	        }
