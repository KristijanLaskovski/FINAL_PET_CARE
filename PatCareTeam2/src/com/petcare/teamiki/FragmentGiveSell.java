...
import com.petcare.teamiki.HomeFragment.LoadComments;
import com.petcare.teamiki.HomeFragment.LoadREMINDINGComments;
...
public class FragmentGiveSell extends android.support.v4.app.ListFragment
	...
	private static final String READ_COMMENTS_URL = "http://www.petcarekl.com/webservice/sellcomments.php";
	private static final String READ_REMINDING_COMMENTS_URL = "http://www.petcarekl.com/webservice/sellreminding.php";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		NetworkInfo networkInfo2 = connMgr
		...
		if (isWifiConn == true || isMobileConn == true) {
			...
			View rootView = inflater.inflate(R.layout.fragment_by_sell_give,
					container, false);

			listViewOnHome = (ListView) rootView
			...
			// Toast.makeText(getActivity(),
			// "You dont have internet connection", Toast.LENGTH_SHORT).show();
